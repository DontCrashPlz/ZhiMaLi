...
package com.zheng.zchlibrary.widgets.progressDialog;
...
public abstract class BaseProgressDialog extends Dialog {
    ...
    public BaseProgressDialog(Context context, String requestTag) {
        super(context);
        mRootVew = getLayoutInflater().inflate(R.layout.kprogresshud_hud, null, false);
        setWindowDimAmount(DIM_AMOUNT);
        initViews();
    ...
    public void onBackPressed() {
        Log.e("TAG","ondismiss");
        this.dismiss();
//        if (mRequestTag.length()>0){
//            VolleyHelper.getInstance(mContext).cancelRequestByTag(mRequestTag);
//            Log.e("TAG","RequestCanceled--->"+mRequestTag);
//        }
        super.onBackPressed();
    }
